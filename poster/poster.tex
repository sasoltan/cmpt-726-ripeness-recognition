...
Hence, we are now ready to construct general Hamiltonian systems and  investigate their dynamics. Currently, we are investigating the generic codimension-one bifurcations that could arise from Hamiltonian coupled cell systems. 
\end{block}
%\vskip1ex
